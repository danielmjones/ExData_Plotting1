#Plot4.R file used to create plot 4.
...
# Code for Plot 4 - png plot created, graphs written to plot and then device turned off.
...
plot(datsub$Datetime,datsub$Voltage, type = "l", xlab="datetime", ylab="Voltage")
...
plot(datsub$Datetime,datsub$Global_reactive_power, type = "l", xlab="datetime", ylab="Global_reactive_power")
dev.off()